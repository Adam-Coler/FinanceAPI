#  downloads all tickers in "s_and_p" list and saves as seperate csvs using IEX API
...
def download_stock(stock):
    try:
        ...
        stock_df['Name'] = stock
        output_name = output_dir + stock + '_data.csv'
...
if __name__ == '__main__':
    ...
    if len(bad_names) > 0:
        with open(output_dir + 'failed_queries.txt', 'w') as outfile:
